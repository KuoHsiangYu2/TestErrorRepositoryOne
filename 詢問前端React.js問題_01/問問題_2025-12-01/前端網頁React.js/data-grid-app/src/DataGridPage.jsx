...
function DataGridPage() {
  ...
  useEffect(() => {
    async function fetchTableData() {
      ...
      // fetch data.
      const tempTableHeader = await apiService.getTableHeader();
      const tempTableBody = await apiService.getTableBody();
  ...
  const filteredData = useMemo(() => {
    return tableBody.filter((row) => row.title.toLowerCase().includes(searchText.toLowerCase()));
